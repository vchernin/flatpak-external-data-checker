...
class SubmoduleChecker:
    ...
    async def _prepare_submodules(self) -> None:
        ...
        updatable_submodule_paths = await asyncio.to_thread(
            self._run_cmd,
            [
                "git",
                "-C",
        ...
        updatable_submodule_paths_split = updatable_submodule_paths.stdout.decode(
            "utf-8"
        ).splitlines()
        ...
        for submodule in all_submodule_paths_split:
            ...
            s = Submodule(
                submodule,
                submodule not in updatable_submodule_paths_split,
    ...
    async def _update_submodule_commit(self, submodule: Submodule) -> None:
        ...
        PRE: submodule has an update available, has at least one module being updated, and is updatable (not nested)"""
    ...
    def print_outdated(self, submodule_data):
